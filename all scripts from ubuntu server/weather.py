...
api_key = os.getenv('OWN_API_KEY') # my own key, which should be exported to enviroment variable, using export OWN_API_KEY=<my api key>
# we use echo $OWN_API_KEY to see if the env. variable exists
...
#url = f"http://api.openweathermap.org/data/2.5/weather?q={args.country}&appid={api_key}"
